...
const Stack = () => {
    return (
        <section
            id="stack"
            className="relative overflow-hidden bg-[#1C1410] w-full py-36"
        >
            ...
            <div className="mx-auto max-w-7xl px-12">
                ...
                <div className="mb-20">
                    ...
                    <h2 className="leading-[0.88] tracking-[-0.03em]">
                        <span className="block text-[clamp(3rem,7vw,8rem)] font-black text-[#F0EBE1]">
                            Built With
                        </span>
                ...
                <div className="mb-10 overflow-hidden rounded-4xl border border-white/10 bg-white/3 backdrop-blur-xl">
                    <div className="grid lg:grid-cols-2">
                        ...
                        <div className="p-12">
                            ...
                            <h3 className="text-[clamp(3rem,6vw,6rem)] font-black leading-[0.9] tracking-tight text-[#F0EBE1]">
                                NEXT.JS
                                <br />
                                REACT
                            </h3>
                        ...
                        <div className="flex items-center justify-center border-t border-white/10 lg:border-l lg:border-t-0">

                            <div className="relative flex h-72 w-72 items-center justify-center">

                                <div className="absolute h-full w-full rounded-full border border-[#E8521A]/20" />

                                <div className="absolute h-56 w-56 rounded-full border border-[#E8521A]/30" />

                                <div className="absolute h-40 w-40 rounded-full border border-[#E8521A]/40" />

                                <div className="text-[5rem] font-black text-[#F0EBE1]/10">
                                    ⚛
                                </div>
                ...
                <div className="grid gap-px bg-white/10 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    {stack.map((item) => (
                        <div
                            key={item.name}
                            className="group bg-[#1C1410] p-8 transition-all duration-300 hover:bg-[#E8521A]"
                        >
                            <div className="mb-4 text-xs uppercase tracking-[0.2em] text-[#E8521A] group-hover:text-white/70">
                                {item.level}
                            </div>

                            <h3 className="mb-3 text-3xl font-black tracking-tight text-[#F0EBE1]">
                                {item.name}
                            </h3>
                ...
                <div className="mt-20 grid gap-10 border-t border-white/10 pt-12 md:grid-cols-4">
                    ...
                    <div>
                        <div className="text-5xl font-black text-[#F0EBE1]">15+</div>
                    ...
                    <div>
                        <div className="text-5xl font-black text-[#F0EBE1]">20+</div>
                        <div className="mt-2 text-xs uppercase tracking-[0.2em] text-white/40">
                            Projects Built
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="text-5xl font-black text-[#F0EBE1]">100%</div>
                        <div className="mt-2 text-xs uppercase tracking-[0.2em] text-white/40">
                            Self Taught
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="text-5xl font-black text-[#F0EBE1]">∞</div>
                        <div className="mt-2 text-xs uppercase tracking-[0.2em] text-white/40">
                            Curiosity Level
                        </div>
                    </div>
