...
const Contact = () => {
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        window.location.href = `mailto:adarshantony223@gmail.com?subject=${subject}&body=${body}`;
    };
    ...
    return (
        ...
        >
            ...
            <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
                <div className="grid gap-12 lg:gap-24 lg:grid-cols-[1.1fr_0.9fr]">
                    ...
                    <div>
                        ...
                        <p className="mt-8 max-w-xl font-serif text-[clamp(1.1rem,2vw,2.2rem)] italic leading-relaxed text-[#7A6E65]">
                        ...
                        <div className="mt-10 sm:mt-12 flex flex-col">
                            {contactLinks.map((link) => (
                                <a
                                    ...
                                    className="group flex items-center justify-between border-b border-black/10 py-4 sm:py-5 transition-all hover:pl-3 gap-3"
                                >
                                    <span className="shrink-0 w-16 sm:w-[90px] text-[11px] uppercase tracking-[0.2em] text-[#7A6E65] group-hover:text-[#E8521A]">
                                        {link.label}
                                    </span>

                                    <span className="font-medium text-[#1C1410] text-sm sm:text-base truncate">
                                        {link.value}
                                    </span>

                                    <span className="shrink-0 text-xl text-black/30 transition-all group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:text-[#E8521A]">
                                        ↗
                                    </span>
                                </a>
                            ))}
                        ...
                        <div className="mt-8 sm:mt-10 inline-flex items-center gap-3 rounded-full border border-[#E8521A]/20 bg-[#E8521A]/5 px-5 py-3">
                    ...
                    {/* RIGHT */}
                    <div className="rounded-[2rem] border border-black/5 bg-white/50 p-7 sm:p-10 backdrop-blur-xl">
                        <div className="mb-8 sm:mb-10">
                            <div className="text-xs uppercase tracking-[0.25em] text-[#7A6E65]">
                                Send Message
                            </div>

                            <h3 className="mt-3 text-3xl sm:text-4xl font-black text-[#1C1410]">
