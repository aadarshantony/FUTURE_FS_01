const Hero = () => {
    return (
        <section id="hero" className="relative mb-5 overflow-hidden pt-24 sm:pt-28 lg:pt-32 w-full">
            <div className="pointer-events-none absolute right-0 top-12 select-none text-[clamp(4rem,16vw,20rem)] font-black leading-none text-[#1C1410]/5">
                PORTFOLIO
            </div>
            ...
            <div className="mx-auto w-full max-w-7xl px-5 sm:px-8 lg:px-12">
                ...
                <div className="mt-8 sm:mt-12 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">

                    {/* LEFT */}
                    <div className="lg:col-span-7">
                        <p className="max-w-xl text-base sm:text-lg leading-8 sm:leading-9 text-[#7A6E65]">
                        ...
                        <div className="mt-8 sm:mt-10 flex flex-wrap gap-3">
                            {["Next.js", "React", "TypeScript", "Node.js", "Tailwind", "MongoDB"].map((item) => (
                                <span
                                    key={item}
                                    className="rounded-full border border-[#1C1410]/15 px-4 sm:px-5 py-2 text-sm"
                                >
                                    {item}
                                </span>
                            ))}
                        ...
                        <div className="mt-6 sm:mt-7 flex flex-wrap gap-4">
                            <a
                                href="#projects"
                                className="rounded-full bg-[#E8521A] px-7 sm:px-8 py-3 sm:py-4 text-sm uppercase tracking-widest text-[#F0EBE1] shadow-lg transition-all hover:-translate-y-1"
                            >
                                View Projects
                            </a>
                            ...
                            <a
                                href="#contact"
                                className="rounded-full border border-[#1C1410]/20 px-7 sm:px-8 py-3 sm:py-4 text-sm uppercase tracking-widest transition-all hover:bg-[#1C1410] hover:text-[#F0EBE1]"
                            >
                                Contact Me
                            </a>
                        </div>
                    ...
                    <div className="lg:col-span-5">
                        ...
                        <div className="rounded-4xl border border-[#1C1410]/10 bg-white/40 p-6 sm:p-8 backdrop-blur-xl">

                            <div className="mb-6 text-xs uppercase tracking-[0.25em] text-[#7A6E65]">
                                Currently
                            </div>

                            <h3 className="text-2xl sm:text-3xl font-bold text-[#1C1410]">
                                B.Tech CSE Student
                            </h3>
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-4">
                            ...
                            <div className="rounded-3xl border border-[#1C1410]/10 p-6">
                                <h4 className="text-3xl sm:text-4xl font-black text-[#1C1410]">
                                    15+
                                </h4>
