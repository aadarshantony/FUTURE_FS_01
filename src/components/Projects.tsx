        ...
        >
            ...
            <div className="mx-auto w-full max-w-7xl px-12">
                ...
                <div className="mb-16 flex items-end justify-between">
                    ...
                    <div className="text-right italic text-[#7A6E65]">
                        2024 — 2026
                ...
                {/* Featured Project */}
                <div className="group relative mb-20 overflow-hidden rounded-4xl border border-black/5 bg-white/50 backdrop-blur-xl">
                    <div className="absolute right-0 top-0 h-64 w-64 rounded-full bg-[#E8521A]/10 blur-3xl" />

                    <div className="grid lg:grid-cols-2">
                        <div className="relative flex min-h-125 items-center justify-center overflow-hidden border-r border-black/5">
                            <div className="absolute h-72 w-72 rounded-full bg-[#E8521A]/10 blur-3xl" />

                            <div className="relative w-[75%] overflow-hidden rounded-2xl bg-[#111] shadow-2xl">
                                ...
                                <div className="space-y-4 p-6">
                                    ...
                                    <div className="h-40 rounded-xl bg-[#E8521A]/10" />
                        ...
                        <div className="flex flex-col justify-center p-12">
                            ...
                            <h3 className="mb-5 text-6xl font-black tracking-tight text-[#1C1410]">
                ...
                <div className="mt-8 border-t border-black/10">
                    {projects.map((project, index) => (
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-col gap-6 py-10 lg:flex-row lg:items-center lg:justify-between">
                                <div className="flex items-start gap-6">
                                    ...
                                    <div>
                                        <h3 className="text-2xl font-black tracking-[-0.03em] text-[#1C1410] transition-colors duration-300 group-hover:text-white md:text-3xl">
                                            {project.title}
                                        </h3>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="group/arrow flex items-center gap-5"
                                >
                                    ...
                                    <div className="flex h-12 w-12 items-center justify-center rounded-full border border-black/10 bg-black/5 text-lg text-[#1C1410] transition-all duration-500 group-hover:border-white/20 group-hover:bg-white/10 group-hover:text-white group-hover/arrow:-translate-y-1 group-hover/arrow:translate-x-1">
                                        ↗
                                    </div>
                                </a>
                            </div>
